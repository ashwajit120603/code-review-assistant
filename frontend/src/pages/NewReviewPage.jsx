...
//   useEffect(() => {
//     // When a new review arrives, smoothly scroll the result into view
...
//       console.error(err);
//       setError(
//         err.response?.data?.error || "Failed to generate review. Try again."
//       );
//     } finally {
//       setIsLoading(false);
//     }
...
//       {/* Hero header */}
//       <section className="rounded-2xl bg-gradient-to-r from-slate-900 via-slate-800 to-blue-700 text-white px-5 py-6 shadow-lg">
...
//               Paste your code, run an AI review, and immediately see structured feedback,
//               scores, and complexity analysis side by side.
//             </p>
//           </div>
...
//               disabled={isLoading}
//               className="inline-flex items-center justify-center px-6 py-2.5 rounded-full bg-blue-400 text-slate-900 text-sm font-semibold shadow-md hover:bg-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-200 focus:ring-offset-2 focus:ring-offset-slate-900 disabled:opacity-60"
//             >
//               {isLoading ? "Running review..." : "Run Code Review"}
//             </button>
//             <span className="inline-flex items-center gap-1 rounded-full bg-slate-800/70 px-3 py-1 text-[11px] font-medium text-slate-200">
//               <span className="h-1.5 w-1.5 rounded-full bg-emerald-400 animate-pulse" />
//               Live LLM-powered analysis
//             </span>
//           </div>
//         </div>
//       </section>

//       {/* Main workspace: editor + live review */}
//       <section className="grid gap-4 md:grid-cols-2">
//         {/* Left: files editor */}
//         <div className="bg-white rounded-xl shadow-sm p-4 md:p-5 space-y-4">
//           <div className="flex items-center justify-between gap-2">
//             <div>
//               <h3 className="text-base font-semibold">Source files</h3>
//               <p className="text-xs text-slate-500">
//                 Add multiple files and select the language for better feedback.
//               </p>
//             </div>
//             <button
//               type="button"
...
//                   onRemove={files.length > 1 ? () => removeFile(file.id) : null}
//                 />
//               ))}
//             </div>
...
//               <p className="text-xs text-slate-500">
//                 Run a review to see scores, complexity, and detailed comments here.
//               </p>
//             </div>
//           </div>
...
//                 <span className="font-semibold">Run Code Review</span> to generate an
//                 AI review instantly.
//               </p>
//             </div>
//           )}
