...
//           <h3 className="text-sm font-semibold">Time & Space Complexity</h3>
//           {complexity.overallTime && (
//             <p>
//               <span className="font-medium">Time:</span>{" "}
//               <span>{complexity.overallTime}</span>
//             </p>
//           )}
//           {complexity.overallSpace && (
//             <p>
//               <span className="font-medium">Space:</span>{" "}
//               <span>{complexity.overallSpace}</span>
//             </p>
//           )}
//           {complexity.notes && (
//             <p className="text-slate-600">{complexity.notes}</p>
//           )}
//         </div>
//       )}

//       {fileReviews && fileReviews.length > 0 && (
...
//                       <th className="border px-2 py-1 text-left">Issue</th>
...
//                   No specific comments for this file.
//                 </p>
//               )}
//             </div>
//           ))}
...
//       {globalSuggestions && globalSuggestions.length > 0 && (
